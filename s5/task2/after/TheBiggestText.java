package org.example.task2.after;
...
public class TheBiggestText {
    ...
    public static void runTests(){
        ...
        String actual1 = findBiggestText("USA","Egypt","Home");
        ...
        String actual2 = findBiggestText("egypt","Egypt","USA");
        ...
        String actual3 = findBiggestText("UK","USA","usa");
    ...
    public static String findBiggestText(String text1, String text2, String text3){
        if(text1.length() >= text2.length() &&
        text1.length() >= text3.length()){
            return text1;
        }else if(text2.length() >= text1.length() &&
                text2.length() >= text3.length()){
            return text2;
        }else {
            return text3;
        }
